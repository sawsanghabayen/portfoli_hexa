        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline mr-5">
                    <h3>{{ucwords(__('cp.experiences'))}}</h3>
                </div>
            </div>
            <!--end::Info-->
            <!--begin::Toolbar-->
            ...
            <div>
                ...
                <a href="{{url(getLocal().'/admin/experiences/create')}}" class="btn btn-secondary  mr-2 btn-success">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover tableWithSearch" id="tableWithSearch">
                            ...
                            <tr>
                                ...
                                <th class="wd-10p"> {{ucwords(__('cp.experience_name'))}}</th>
                            ...
                            @forelse($experiences as $one)
                                <tr class="odd gradeX" id="tr-{{$one->id}}">
                                    ...
                                    <td class="v-align-middle wd-10p" > {{$one->experience_name}}</td>
                                    ...
                                    <td class="v-align-middle wd-15p optionAddHours">
                                        <a href="{{url(getLocal().'/admin/experiences/'.$one->id.'/edit')}}"
...
function confirmDelete(id, reference) {
     ...
     function performDelete(id, reference) {
        axios.delete('/admin/experiences/'+id)
