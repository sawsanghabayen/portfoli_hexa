    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <form method="post" action="{{url(app()->getLocale().'/admin/experiences/'.$experience->id)}}"
                    ...
                    <div class="row col-sm-12">
                        <div class="card-body">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-12">
                                <div class="dropdown bootstrap-select form-control dropup">
                                    <select class="form-control selectpicker" data-size="7"  name="type_id" required
                                        ...
                                        <option value="{{$experience->type_id}}" selected>{{__('cp.full_time')}}</option>
                                        <option value="{{$experience->type_id}}" selected>{{__('cp.part_time')}}</option>
                            ...
                            <div class="form-group row mt-4">
                                ...
                                <div class="col-9">
                                    <input required type="date" class="form-control" value="{{$experience->start_date}}" name="start_date" 
                                ...
                                @foreach($locales as $locale)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            type="text" class="form-control" id="company_name" name="company_name_{{$locale->lang}}"
                                            placeholder="Enter company_name" value="{{old('company_name_'.$locale->lang,@$experience->translate($locale->lang)->company_name)}}"/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{__('cp.experience_name_'.$locale->lang)}}</label>
                                                      ...
                                                      <input required  
                                                      {{($locale->lang == 'ar') ? 'dir=rtl' :'' }} 
                                                      type="text" class="form-control" id="experience_name"  name="experience_name_{{$locale->lang}}"
                                            placeholder="Enter experience_name" value="{{old('experience_name_'.$locale->lang,@$experience->translate($locale->lang)->experience_name)}}"/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control form-control-solid"
                                                      ...
                                                      required>{{old('description_'.$locale->lang,@$experience->translate($locale->lang)->description)}}</textarea>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
