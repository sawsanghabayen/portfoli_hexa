            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline mr-5">
                        <h3>{{__('cp.show_join_requests')}}</h3>
                    </div>
                </div>
                <!--end::Info-->
                <!--begin::Toolbar-->
                <div class="d-flex align-items-center">
                    <a href="{{url(getLocal().'/admin/join_requests')}}" class="btn btn-secondary  mr-2">{{__('cp.cancel')}}</a>
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <form  enctype="multipart/form-data" class="form-horizontal" action="{{url(app()->getLocale().'/admin/join_requests/'.$item->id)}}" method="post" role="form" id="form">
                        {{ csrf_field() }}
                        {{ method_field('PATCH')}}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                   name="mobile" value="{{old('mobile',@$item->mobile)}}" disabled />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control"
                                                      name="description" disabled >{{$item->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
