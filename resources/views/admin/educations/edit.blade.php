    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <form method="post" action="{{url(app()->getLocale().'/admin/educations/'.$education->id)}}"
                                ...
                                @foreach($locales as $locale)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter company_name" value="{{old('company_name_'.$locale->lang,@$education->translate($locale->lang)->company_name)}}"/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{__('cp.education_name_'.$locale->lang)}}</label>
                                                      ...
                                                      <input required  
                                                      {{($locale->lang == 'ar') ? 'dir=rtl' :'' }} 
                                                      type="text" class="form-control" id="education_name"  name="education_name_{{$locale->lang}}"
                                            placeholder="Enter education_name" value="{{old('education_name_'.$locale->lang,@$education->translate($locale->lang)->education_name)}}"/>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control form-control-solid"
                                                      ...
                                                      required>{{old('description_'.$locale->lang,@$education->translate($locale->lang)->description)}}</textarea>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
