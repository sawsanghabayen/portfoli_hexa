    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div>
                ...
                <a href="{{url(getLocal().'/admin/skills/create')}}" class="btn btn-secondary  mr-2 btn-success">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover tableWithSearch" id="tableWithSearch">
                            ...
                            <tr>
                                ...
                                <th class="wd-10p"> {{ucwords(__('cp.title'))}}</th>
                                <th class="wd-10p"> {{ucwords(__('cp.degree'))}}</th>
                                <th class="wd-10p"> {{ucwords(__('cp.created'))}}</th>
                                <th class="wd-15p"> {{ucwords(__('cp.action'))}}</th>
                            </tr>
                            </thead>
                            <tbody>
                            @forelse($skills as $one)
                                <tr class="odd gradeX" id="tr-{{$one->id}}">
                                    ...
                                    <td class="v-align-middle wd-10p" > {{$one->title}}</td>
                                    <td class="v-align-middle wd-10p" > {{$one->degree}}</td>
                                    <td class="v-align-middle wd-25p">{{$one->created_at}}</td>



                                    <td class="v-align-middle wd-15p optionAddHours">
                                        <a href="{{url(getLocal().'/admin/skills/'.$one->id.'/edit')}}"
