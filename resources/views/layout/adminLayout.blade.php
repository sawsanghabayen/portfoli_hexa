							...
							<ul class="menu-nav">
                                ...
                                <li class="menu-item {{(explode("/", request()->url())[5] == "home") ? "menu-item-here" : ''}}" aria-haspopup="true">
									...
									<li class="menu-section">
										<h4 class="menu-text">{{__('cp.hr')}}</h4>
                                ...
                                {{-- @if(can(['providers-show' , 'providers-create' , 'providers-edit' , 'providers-delete'])) --}}
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/projects')}}" class="menu-link">
											<span class="svg-icon menu-icon">
                                            ...
                                            <span class="menu-text">{{__('cp.projects')}}</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/educations')}}" class="menu-link">
											<span class="svg-icon menu-icon">
												<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <span class="menu-text">{{__('cp.educations')}}</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/experiences')}}" class="menu-link">
											<span class="svg-icon menu-icon">
												<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <span class="menu-text">{{__('cp.experiences')}}</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/skills')}}" class="menu-link">
											<span class="svg-icon menu-icon">
												<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
												<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <span class="menu-text">{{__('cp.skills')}}</span>
                                        </a>
                                    </li>
